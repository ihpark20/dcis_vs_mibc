...
accession **GSE343808**, one sample per tissue microarray. Download these files per slide
(`GSM9963125_TMA1_*` and the corresponding `GSM*_TMA2_*`) into a single directory:
